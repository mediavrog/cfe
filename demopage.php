...
// static vars
$title = "Demopage for custom form elements";
...
window.addEvent('domready', function(){
	var myCfe = new cfe.base(true);
		...
		$('chb1').retrieve("cfe").addEvent("hover", function(){
...
if(isset($_GET['tech']) && in_array($_GET['tech'], array_keys($tech))){
...
<?php
	...
	foreach($ct['libs'] as $l=>$path){
		
		echo '<script type="text/javascript" src="cfe/'.$ct['path'].'/lib/'.$path.'"></script>';
		
	}
?>

<!-- add modules -->
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/base/cfe.base.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.checkbox.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.radio.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.text.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.textarea.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.select.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.image.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.submit.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.reset.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.file.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.password.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/modules/cfe.module.fieldset.js"></script>

<!-- add extensions -->
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/addons/cfe.addon.toolTips.js"></script>
<script type="text/javascript" src="cfe/<?php echo $ct['path']; ?>/addons/cfe.addon.dependencies.js"></script>
...
<p>Choose your favourite technique/javascript framework you want to use custom form elements with:</p>
<ul>
	<li><a href="?tech=mt11" title="Mootools 1.1">Mootools 1.1</a></li>
	<li><a href="?tech=mt12" title="Mootools 1.2">Mootools 1.2</a></li>
</ul>

<h2>custom form elements in action</h2>
<h4>Postvariables:</h4>
<pre>
<?php var_dump($_POST); ?>
</pre>
