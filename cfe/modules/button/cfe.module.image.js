...
cfe.generic,
{
    ...
    {
        this.clearState();
        var ind = this.o.attr("src").lastIndexOf(".");
	this.o.attr("src" , this.o.attr("src").substring(0,ind) + this.options.statePrefix + state + this.o.attr("src").substring(ind) );
	},
    ...
    clearState: function()
    {
        this.o.attr("src",  this.o.attr("src").replace(this.stateRegEx, "") );
    },
