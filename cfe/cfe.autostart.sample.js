...
$(document).ready(function()
{
    ...
    //    });
    //
    //    myGeneric.toElement().html("Generic Test").appendTo( $("#form") );
    //
    //    console.log( myGeneric.toElement() );

    var myCfe = new cfe.replace();
    
    // no fieldset enhancement
    myCfe.unregisterModules(["fieldset","select_multiple"]);
